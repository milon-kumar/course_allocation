var colors = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"],dataColors = $("#campaign-sent-chart").data("colors");
    ...
    series: [
        {
            name: "Total Revenue",
            type: "area",
            data: [44, 55, 31, 47, 31, 43, 26, 41, 31, 47, 33, 43, 60],
        },
        {
            name: "Total Pipeline",
            type: "line",
            data: [55, 69, 45, 61, 43, 54, 37, 52, 44, 61, 43, 56, 100],
        },
    ],
