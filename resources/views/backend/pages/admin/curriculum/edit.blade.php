            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('admin.curriculum.update',$curriculum->id)}}">
                            @csrf
                            @method('PUT')
                            <div class="mb-2 row">
                                ...
                                <div class="col-sm-10">
                                    <select name="department_id" class="form-control select2 @error('department_id') border border-danger @enderror" data-toggle="select2">
                                        ...
                                        @foreach ($departments as $department)
                                            <option value="{{$department->id}}" {{ $curriculum->department_id == $department->id ? 'selected' : ''}}>{{ $department->name ?? '---'}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mb-2 row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    name="name"
                                    value="{{ $curriculum->name ?? old('name')}}">
