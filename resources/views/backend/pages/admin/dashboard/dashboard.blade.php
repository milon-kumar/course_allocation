                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="text-muted fw-normal mt-0 text-truncate" title="Campaign Sent">Departments</h5>
                                <h3 class="my-2 py-1">{{ $departments ?? 0  }}</h3>
                            </div>
                        </div> <!-- end row-->
                    </div> <!-- end card-body -->
                </div> <!-- end card -->
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="text-muted fw-normal mt-0 text-truncate" title="Campaign Sent">Teachers</h5>
                                <h3 class="my-2 py-1">{{ $teachers ?? 0 }}</h3>
                            </div>
                        </div> <!-- end row-->
                    </div> <!-- end card-body -->
                </div> <!-- end card -->
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="text-muted fw-normal mt-0 text-truncate" title="Campaign Sent">Request Allocation</h5>
                                <h3 class="my-2 py-1">{{ $allocation['requested_count'] ?? 0 }}</h3>
                            </div>
                        </div> <!-- end row-->
                    </div> <!-- end card-body -->
                </div> <!-- end card -->
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-7">
                                <h5 class="text-muted fw-normal mt-0" title="Campaign Sent">Approved Allocation</h5>
                                <h3 class="my-2 py-1">{{ $allocation['approved_count'] ?? 0 }}</h3>
                            </div>
                        </div> <!-- end row-->
                    </div> <!-- end card-body -->
                </div> <!-- end card -->
...
{{--                                 src="{{asset('/')}}assets/backend/images/users/avatar-2.jpg" width="40"--}}
...
{{--                            <img class="me-3 rounded-circle"--}}
{{--                                 src="{{asset('/')}}assets/backend/images/users/avatar-3.jpg" width="40"--}}
{{--                                 alt="Generic placeholder image">--}}
{{--                            <div class="w-100 overflow-hidden">--}}
...
{{--                        <div class="d-flex align-items-start mt-3">--}}
{{--                            <img class="me-3 rounded-circle"--}}
{{--                                 src="{{asset('/')}}assets/backend/images/users/avatar-4.jpg" width="40"--}}
{{--                                 alt="Generic placeholder image">--}}
{{--                            <div class="w-100 overflow-hidden">--}}
...
{{--                        <div class="d-flex align-items-start mt-3">--}}
{{--                            <img class="me-3 rounded-circle"--}}
{{--                                 src="{{asset('/')}}assets/backend/images/users/avatar-5.jpg" width="40"--}}
{{--                                 alt="Generic placeholder image">--}}
{{--                            <div class="w-100 overflow-hidden">--}}
{{--                                <span class="badge badge-warning-lighten float-end">Cold lead</span>--}}
...
{{--                        <div class="d-flex align-items-start mt-3">--}}
{{--                            <img class="me-3 rounded-circle"--}}
{{--                                 src="{{asset('/')}}assets/backend/images/users/avatar-1.jpg" width="40"--}}
{{--                                 alt="Generic placeholder image">--}}
{{--                            <div class="w-100 overflow-hidden">--}}
{{--                                <span class="badge badge-warning-lighten float-end">Cold lead</span>--}}
...
{{--                        <div class="d-flex align-items-start mt-3">--}}
{{--                            <img class="me-3 rounded-circle"--}}
{{--                                 src="{{asset('/')}}assets/backend/images/users/avatar-6.jpg" width="40"--}}
{{--                                 alt="Generic placeholder image">--}}
{{--                            <div class="w-100 overflow-hidden">--}}
{{--                                <span class="badge badge-success-lighten float-end">Won lead</span>--}}
...
{{--                            </div>--}}
{{--                            <img class="ms-3" src="{{asset('/')}}assets/backend/images/email-campaign.svg" width="120"--}}
{{--                                 alt="Generic placeholder image">--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <!-- end card-body -->--}}
