            ...
            <div class="col-md-10">
                <div class="card shadow-lg border-0" style="border-radius: 16px; overflow: hidden;">
                    ...
                    <div class="card-body bg-primary text-white text-center py-5">
                        ...
                        <div class="mx-auto rounded-circle bg-white text-primary d-flex justify-content-center align-items-center"
                             style="width: 120px; height: 120px; font-size: 48px; font-weight: bold;">
                            {{ $avatar }}
                        </div>

                        <h3 class="mt-3 mb-1">{{ $student->name }}</h3>
                    ...
                    <div class="card-body p-4">
                        ...
                        <h5 class="mb-3 text-uppercase text-muted">Personal Information</h5>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="p-3 border rounded shadow-sm bg-light">
                                    ...
                                    <span class="fw-semibold">{{ $student->priority }}</span>
                                </div>
                            </div>
                        </div>

                        <h5 class="mb-3 text-uppercase text-muted">System Information</h5>

                        <div class="row mb-3">
                            <div class="col-md-6 mb-3">
                                <div class="p-3 border rounded shadow-sm bg-light">
                                    <small class="text-muted d-block">Account Created At</small>
                                    <span class="fw-semibold">{{ $student->created_at }}</span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="p-3 border rounded shadow-sm bg-light">
                                    ...
                                    <span class="fw-semibold">{{ $student->updated_at }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-end">
                            <a href="#" class="btn btn-primary btn-lg px-4">
                                <i class="uil-edit"></i> Edit Profile
                            </a>
                        </div>
